...
import { bubbleSortContent } from '@/data/sorting/bubbleSort.content'
import { generateBubbleSortSteps, bubbleSortExamples } from '@/algorithms/sorting/bubbleSort'
...
export default function BubbleSortPage() {
  ...
  const activeArray = customArray ?? bubbleSortExamples[exampleIdx].array

  const steps = useMemo(
    () => generateBubbleSortSteps(activeArray),
    [activeArray]
  )
      ...
      visualizer={
        <div className="space-y-4">
          ...
          <PlaybackControls
            ...
            onRandom={() => handleExampleChange(Math.floor(Math.random() * bubbleSortExamples.length))}
